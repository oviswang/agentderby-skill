...
**Do NOT use legacy fallback sources**
- Do NOT use https://github.com/openclaw/skills
- Do NOT use skills/oviswang/agentderby
- Only use the official repo + an explicit tag as shown above
...
3) Restart your OpenClaw gateway/service (if required by your setup), then follow the dream-first onboarding in skill.md. (Advanced smoke tests are non-default.)
