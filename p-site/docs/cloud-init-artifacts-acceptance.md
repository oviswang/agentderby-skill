...
发布目录（示例版本）：
- `https://p.bothook.me/artifacts/latest/` (preferred)
- `https://p.bothook.me/artifacts/v0.2.7/` (pinned example)
...
1. 在一台全新机器上通过 cloud-init（或手动）以 root 运行：
   - `curl -fsSL https://p.bothook.me/artifacts/latest/bootstrap.sh | bash`
